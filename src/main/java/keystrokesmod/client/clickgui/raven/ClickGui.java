...
public class ClickGui extends GuiScreen {
   ...
   public void drawScreen(int x, int y, float p) {
      ...
      this.drawCenteredString(this.fontRendererObj, "B", halfScreenWidth + 1 - w_c, quarterScreenHeight - 25, Utils.Client.rainbowDraw(2L, 1500L));
      ...
      this.drawCenteredString(this.fontRendererObj, "S", halfScreenWidth - w_c, quarterScreenHeight - 5, Utils.Client.rainbowDraw(2L, 900L));
      ...
      this.drawCenteredString(this.fontRendererObj, "x", halfScreenWidth - w_c, quarterScreenHeight + 15, Utils.Client.rainbowDraw(2L, 300L));
      this.drawCenteredString(this.fontRendererObj, "y", halfScreenWidth + 1 + w_c, quarterScreenHeight + 30, Utils.Client.rainbowDraw(2L, 0L));
      ...
      if(latestVersion.isNewerThan(clientVersion)){
         ...
         mc.fontRendererObj.drawString("Raven BSexy"+ " | Config: " + Raven.configManager.getConfig().getName(), 4, this.height - 3 - mc.fontRendererObj.FONT_HEIGHT, Utils.Client.astolfoColorsDraw(10, 14, speed));
      }
